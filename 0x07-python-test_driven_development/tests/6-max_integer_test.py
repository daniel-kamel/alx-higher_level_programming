...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_ints_and_floats_large(self):
        """Tests larger list with ints and floats"""
        self.assertEqual(
            max_integer(
    ...
    def test_floats_large(self):
        """Tests larger list with only floats"""
        self.assertEqual(
            max_integer(
    ...
    def test_numeric_string(self):
        """Tests string of numbers"""
        self.assertEqual(max_integer("192834754"), "9")

    def test_string(self):
        """Tests string of chars"""
